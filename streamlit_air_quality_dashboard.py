...
# Configure page
st.set_page_config(
    page_title="Seoul Air Quality Dashboard", page_icon="🌬️", layout="wide", initial_sidebar_state="expanded"
)
...
def load_data():
    ...
    df["status_label"] = df["instrument_status"].map(
        {0: "Normal", 1: "Need Calibration", 2: "Abnormal", 4: "Power Cut", 8: "Under Repair", 9: "Bad Data"}
    )
