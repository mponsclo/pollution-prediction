        ...
        mlflow.log_metrics(
            {
                ...
                "nrmse_PM2.5": 0.53,
                "avg_nrmse": 0.63,
                "pi_coverage_SO2": 0.621,
                "pi_coverage_NO2": 0.824,
                "pi_coverage_O3": 0.889,
                "pi_coverage_CO": 0.865,
                "pi_coverage_PM10": 0.827,
                "pi_coverage_PM2.5": 0.870,
            }
        )
        ...
        mlflow.log_metrics(
            {
                ...
                "r2_PM10": 0.050,
                "r2_PM2.5": 0.005,
                "pi_coverage_SO2": 0.938,
                "pi_coverage_NO2": 0.917,
                "pi_coverage_O3": 0.905,
                "pi_coverage_CO": 0.936,
                "pi_coverage_PM10": 0.931,
                "pi_coverage_PM2.5": 0.935,
                "avg_pi_coverage": 0.927,
                "improvement_vs_naive_SO2": 14.0,
                "improvement_vs_naive_NO2": 18.0,
                "improvement_vs_naive_O3": 9.0,
                "improvement_vs_naive_CO": 26.0,
                "improvement_vs_naive_PM10": 39.0,
                "improvement_vs_naive_PM2.5": 27.0,
            }
        )
        # Log artifacts
        ...
        mlflow.log_metrics(
            {
                ...
                "f1_227_PM2.5": 0.526,
                "avg_f1": 0.620,
                "precision_205_SO2": 1.000,
                "precision_223_O3": 1.000,
                "precision_224_CO": 0.916,
                "recall_205_SO2": 1.000,
                "recall_223_O3": 1.000,
                "recall_224_CO": 1.000,
            }
        )
